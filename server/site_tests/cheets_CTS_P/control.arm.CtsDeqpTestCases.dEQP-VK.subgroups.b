...
AUTHOR = 'ARC++ Team'
NAME = 'cheets_CTS_P.arm.CtsDeqpTestCases.dEQP-VK.subgroups.b'
...
def run_TS(machine):
    ...
    job.run_test(
        ...
        tag='arm.CtsDeqpTestCases.dEQP-VK.subgroups.b',
        test_name='cheets_CTS_P.arm.CtsDeqpTestCases.dEQP-VK.subgroups.b',
