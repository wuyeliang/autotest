...
AUTHOR = 'ARC++ Team'
NAME = 'cheets_CTS_P.x86.CtsDeqpTestCases.dEQP-VK.subgroups.s'
...
def run_CTS(machine):
    ...
    job.run_test(
        ...
        hosts=host_list,
        iterations=1,
        tag='x86.CtsDeqpTestCases.dEQP-VK.subgroups.s',
        test_name='cheets_CTS_P.x86.CtsDeqpTestCases.dEQP-VK.subgroups.s',
